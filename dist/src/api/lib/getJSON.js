...
const prepVerse = (row, includeMeta = false, liveSearch = 0) => {
  ...
  const verse = {
    ...
    translation: {
      en: Object.assign({}, translations.en),
      pu: {
        ss: {
          gurmukhi: get_1.default(translations, 'pu.ss', ''),
          unicode: get_1.default(translations, 'puu.ss', ''),
        },
        ft: {
          gurmukhi: get_1.default(translations, 'pu.ft', ''),
          unicode: get_1.default(translations, 'puu.ft', ''),
        },
      },
      es: Object.assign({}, translations.es),
    },
  };
  if (liveSearch !== 1) {
